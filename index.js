...
const arr = [new Song('6habFhsOp2NvshLv26DqMb', 'Despacito'), 
new Song('6f807x0ima9a1j3VPbc7VN', "I Don't Care (with Justin Bieber) - Loud Luxury Remix"), 
new Song('4jDmJ51x1o9NZB5Nxxc7gY', 'Careless Whisper'), 
new Song('0TK2YIli7K1leLovkQiNik', 'Señorita'), 
new Song('7mkT9kS25nUIoNkm02Ww0n', 'These Days (feat. Jess Glynne, Macklemore & Dan Caplen)'), 
...
async function setVibes(songsArr) {
    await Promise.all(songsArr.map(async (song) => {
        await song.setVibes()
    }));
}
